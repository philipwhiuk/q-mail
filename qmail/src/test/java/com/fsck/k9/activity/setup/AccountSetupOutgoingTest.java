...
public class AccountSetupOutgoingTest {

    private ActivityController<AccountSetupOutgoing> controller;
    ...
    public void setup() {
        ...
        String transportUri = TransportUris.createTransportUri(new ServerSettings(
                Type.SMTP, "hotmail.com",
                Type.SMTP.defaultPort, ConnectionSecurity.NONE,
                AuthType.PLAIN, "test",
                "password",
                null));
        ...
        controller = Robolectric.buildActivity(AccountSetupOutgoing.class)
                .withIntent(intent)
                .create().resume();
    }
    ...
    public void nextButtonIsEnabled() throws Exception {
        AccountSetupOutgoing activity = controller.get();
