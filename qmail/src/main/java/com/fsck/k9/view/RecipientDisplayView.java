...
import com.fsck.k9.activity.RecipientBuilder;
import com.fsck.k9.activity.compose.RecipientAdapter;
import com.fsck.k9.activity.compose.RecipientLoader;
import com.fsck.k9.mail.Address;
import com.fsck.k9.view.RecipientDisplayView.Recipient;
import com.tokenautocomplete.TokenCompleteTextView;
import org.apache.james.mime4j.util.CharsetUtil;
import timber.log.Timber;


public class RecipientDisplayView extends TokenCompleteTextView<Recipient> implements LoaderCallbacks<List<Recipient>>,
        AlternateRecipientListener<Recipient>, RecipientBuilder<Recipient> {
    ...
    private AlternateRecipientAdapter<Recipient> alternatesAdapter;
    private Recipient alternatesPopupRecipient;
    private TokenListener<Recipient> listener;


    public RecipientDisplayView(Context context) {
        super(context);
        initView(context);
    }

    public RecipientDisplayView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }

    public RecipientDisplayView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void showAlternates(Recipient recipient) {
        ...
        loaderManager.restartLoader(LOADER_ID_ALTERNATES, null, RecipientDisplayView.this);
    }
        ...
        switch (id) {
            ...
            case LOADER_ID_ALTERNATES: {
                ...
                if (contactLookupUri != null) {
                    ...
                    return new RecipientLoader(getContext(), this, cryptoProvider, alternatesPopupRecipient.address);
                }
            }
        }
    ...
    @Override
    public Recipient build(Address address) {
        return new Recipient(address);
    }

    @Override
    public Recipient build(String name, String email, String addressLabel, long contactId, String lookupKey) {
        return new Recipient(name, email, addressLabel, contactId, lookupKey);
    }
    ...
    public static class Recipient extends AbstractRecipient implements Serializable {
