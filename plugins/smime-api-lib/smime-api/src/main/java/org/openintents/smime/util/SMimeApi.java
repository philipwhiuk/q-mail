...
public class SMimeApi {
    ...
    public static final String SERVICE_INTENT_2 = "org.openintents.smime.ISMimeService2";
    ...
    /**
     * This action returns RESULT_CODE_SUCCESS if the S/MIME Provider already has the key
     ...
     */
    public static final String ACTION_BACKUP = "org.openintents.smime.action.BACKUP";
    ...
    ISMimeService2 mService;
    Context mContext;
    final AtomicInteger mPipeIdGen = new AtomicInteger();

    public SMimeApi(Context context, ISMimeService2 service) {
    ...
    class SMimeAsyncTask extends AsyncTask<Void, Integer, Intent> {
        Intent data;
        InputStream is;
        OutputStream os;
