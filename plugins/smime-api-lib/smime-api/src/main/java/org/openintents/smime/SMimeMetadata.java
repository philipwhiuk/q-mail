...
public class SMimeMetadata implements Parcelable {
    /**
    ...
    public SMimeMetadata() {
    }

    public SMimeMetadata(String filename, String mimeType, long modificationTime,
    ...
    public SMimeMetadata(SMimeMetadata b) {
    ...
    public static final Creator<SMimeMetadata> CREATOR = new Creator<SMimeMetadata>() {
        ...
        public SMimeMetadata[] newArray(final int size) {
            return new SMimeMetadata[size];
        }
    };
