...
public enum MessageTransportSecurityDisplayStatus {
    ...
    MessageTransportSecurityDisplayStatus(@AttrRes int colorAttr, @DrawableRes int statusIconRes, @DrawableRes Integer statusDotsRes,
    ...
    MessageTransportSecurityDisplayStatus(@AttrRes int colorAttr, @DrawableRes int statusIconRes) {
        this.colorAttr = colorAttr;
        this.statusIconRes = statusIconRes;
        this.statusDotsRes = null;
    ...
    @NonNull
    private static MessageTransportSecurityDisplayStatus getDisplayStatusForPgpResult(CryptoResultAnnotation cryptoResult) {
    ...
    @NonNull
    private static MessageTransportSecurityDisplayStatus getStatusForPgpEncryptedResult(OpenPgpSignatureResult signatureResult) {
    ...
    @NonNull
    private static MessageTransportSecurityDisplayStatus getStatusForPgpUnencryptedResult(OpenPgpSignatureResult signatureResult) {
        switch (signatureResult.getResult()) {
            case OpenPgpSignatureResult.RESULT_NO_SIGNATURE:
                return DISABLED;
