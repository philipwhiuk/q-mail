...
public class ReceivedHeadersTest {
    ...
    public void wasMessageTransmittedSecurely_withNoHeaders_shouldReturnUnknown() throws MessagingException {
        ...
        assertEquals(SecureTransportError.UNKNOWN,
                ReceivedHeaders.wasMessageTransmittedSecurely(unknownMessage).getErrorType());
    }
    ...
    public void wasMessageTransmittedSecurely_forInsecureMessage_shouldReturnFalse() throws MessagingException {
        ...
        assertEquals(SecureTransportError.INSECURELY_ENCRYPTED,
                ReceivedHeaders.wasMessageTransmittedSecurely(insecureMessage).getErrorType());
    }
    ...
    public void wasMessageTransmittedSecurely_forSecureMessage_shouldReturnTrue() throws MessagingException {
        ...
        assertEquals(SecureTransportError.SECURELY_ENCRYPTED,
                ReceivedHeaders.wasMessageTransmittedSecurely(secureMessage).getErrorType());
    }
}
