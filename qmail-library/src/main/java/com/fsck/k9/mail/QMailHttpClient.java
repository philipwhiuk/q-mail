 ...
 */
public class QMailHttpClient extends DefaultHttpClient {
    /*
    ...
    public static class QMailHttpClientFactory {

        public QMailHttpClient create() {
            return new QMailHttpClient();
        }
    }
