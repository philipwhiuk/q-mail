...
public class SMimeSignatureResult implements Parcelable {
    ...
    public static SMimeSignatureResult createWithNoSignature() {
        return new SMimeSignatureResult(RESULT_NO_SIGNATURE, null, 0L, null, null, null, null);
    }

    public static SMimeSignatureResult createWithKeyMissing(long keyId) {
        return new SMimeSignatureResult(RESULT_KEY_MISSING, null, keyId, null, null, null, null);
    }

    public static SMimeSignatureResult createWithInvalidSignature() {
        return new SMimeSignatureResult(RESULT_INVALID_SIGNATURE, null, 0L, null, null, null, null);
    }
